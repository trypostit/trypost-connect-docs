...
```
GET /social-accounts/connect/linkedin?redirect_url=…
GET /social-accounts/connect/linkedin-page?redirect_url=…
```

Connect hosts LinkedIn OAuth, then a profile / Page picker.
