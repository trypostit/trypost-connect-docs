...
description: "List delivery logs for a webhook, newest first, paginated 25 per page."
---

Requires **manage webhooks** permission (Owner / Admin). IDs from another account return `404`.
...
<RequestExample>
```bash
curl -X GET "https://connect.trypost.it/api/webhooks/a1b2c3d4-e5f6-7890-abcd-ef1234567890/logs?page=1" \
...
```json
{
  ...
  "links": {
    "first": "https://connect.trypost.it/api/webhooks/a1b2c3d4-e5f6-7890-abcd-ef1234567890/logs?page=1",
    "last": "https://connect.trypost.it/api/webhooks/a1b2c3d4-e5f6-7890-abcd-ef1234567890/logs?page=1",
    "prev": null,
    "next": null
  },
  "meta": {
    ...
    "per_page": 25,
    "total": 1,
    "path": "https://connect.trypost.it/api/webhooks/a1b2c3d4-e5f6-7890-abcd-ef1234567890/logs"
  }
}
```
</ResponseExample>
