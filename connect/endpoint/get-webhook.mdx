...
Same fields as one entry in [`GET /webhooks`](/connect/endpoint/list-webhooks), plus `signing_secret`.
...
<RequestExample>
```bash
curl -X GET https://connect.trypost.it/api/webhooks/a1b2c3d4-e5f6-7890-abcd-ef1234567890 \
