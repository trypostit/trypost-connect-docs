...
- Webhook not in this account → `404`
...
<RequestExample>
```bash
curl -X POST https://connect.trypost.it/api/webhooks/a1b2c3d4-e5f6-7890-abcd-ef1234567890/logs/b2c3d4e5-f6a7-8901-bcde-f12345678901/replay \
