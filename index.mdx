...
Connect is a **separate, closed-source** Cloud product. You build your own scheduler; we supply the infrastructure — OAuth, tokens, media, and publishing to 12 networks. It is not this scheduler, and it is not open source.

<Card title="Connect API" icon="plug" href="/connect" horizontal>
  REST and MCP at https://connect.trypost.it
</Card>
